...
function SignUp(){
    ...
    async function createAccount(event){
        ...
        if(!signupData.password.match(/^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[^\w\s]).{8,}$/)){
        ...
        <>
            <HomeLayout>
                <div className="flex justify-center items-center h-[90vh]">
                    <form noValidate onSubmit={createAccount} className="flex flex-col justify-center items-center gap-3 rounded-lg p-6 text-white shadow-[0_0_10px_black] w-[28%]">
                        ...
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <input type="text"
                                   ...
                                   className="bg-transparent border border-white px-2 py-1 outline-none w-full"
                        ...
                        <button type="submit" className="m-2 bg-yellow-600 hover:bg-yellow-500 px-3 py-2 w-full font-semibold rounded text-lg">
                            Create account
                        </button>
