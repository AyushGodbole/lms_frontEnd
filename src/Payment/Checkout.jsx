                ...
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                    <h1 className=" bg-yellow-500
                     ...
                     <div className="px-4 space-y-5 text-center">
                        ...
                        <button type="submit" className=" bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 absolute py-3 bottom-0 w-full left-0 font-bold text-lg rounded-bl-lg rounded-br-lg">
                            Buy now
                        </button>
                     </div>
                </div>                
